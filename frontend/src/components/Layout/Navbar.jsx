...
export default function NavBar() {
    ...
    return (
        <div className="flex min-w-full place-items-center place-content-center">
            <nav className="w-[60%] h-30">
                <div className="border-2 shadow-md hover:shadow-gray-300 flex text-[20px] justify-between max-w-screen-xl mx-auto bg-white rounded-b-xl">
                    ...
                    <ul className="flex justify-between m-5 w-[160px] ">
                        ...
                        <li><Link to="/profile"><Button className="shadow-sm shadow-blue-400 bg-green-400 text-black font-semibold text-[20px] mr-5">My Profile</Button></Link></li>
